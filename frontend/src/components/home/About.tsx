    ...
    <section className="py-20 px-4 max-w-7xl mx-auto">
      ...
      <div className="relative mb-20">
        ...
        <div className="text-center relative z-10">
          <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-pink-300 via-rose-300 to-orange-300 shadow-2xl mb-8 transform hover:scale-105 transition-transform">
            <PawPrint className="w-16 h-16 text-white" />
          </div>

          <h1 className="text-6xl md:text-7xl font-black bg-gradient-to-r from-pink-400 via-rose-400 to-orange-400 bg-clip-text text-transparent mb-6 leading-tight">
            HappyTails
          </h1>

          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-2xl text-gray-700 mb-4 font-light leading-relaxed">
              Where <span className="font-bold text-pink-400">paw-sitive</span> care meets
              <span className="font-bold text-rose-400"> cutting-edge</span> technology
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold text-gray-800 leading-tight">
              Born from a <span className="text-pink-400">Simple Idea</span>
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-pink-100 to-rose-100 rounded-3xl p-8 shadow-2xl transform rotate-2 hover:rotate-0 transition-transform">
      ...
      <div className="mb-20">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-16">
          What Makes Us <span className="text-pink-400">Purr-fect</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="group hover:shadow-2xl transition-all duration-300 border-0 bg-gradient-to-br from-pink-50 to-pink-100 hover:-translate-y-2">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-pink-300 to-rose-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                <Target className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-2xl text-pink-500 mb-2">Our Mission</CardTitle>
            </CardHeader>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 border-0 bg-gradient-to-br from-rose-50 to-rose-100 hover:-translate-y-2">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-rose-300 to-pink-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                <Heart className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-2xl text-rose-500 mb-2">Our Heart</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-gray-700 leading-relaxed">
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 border-0 bg-gradient-to-br from-orange-50 to-orange-100 hover:-translate-y-2">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-orange-300 to-pink-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                <Zap className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-2xl text-orange-500 mb-2">Our Spark</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-gray-700 leading-relaxed">
      ...
      {/* Fun Stats Section */}
      <div className="bg-gradient-to-r from-pink-300 via-rose-400 to-orange-400 rounded-3xl p-12 text-white text-center shadow-2xl">
